...
namespace Domino
{
    public class Function
    {
        ...
        private IModelStore<DominoInputs> store;

        public async Task<DominoOutputs> Handler(DominoInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<DominoInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
            }

            var l = new InvocationWrapper<DominoInputs,DominoOutputs>(store, Domino.Execute);
