...
{
	/// <summary>
	/// Override metadata for SubUnitSetOverride
	/// </summary>
	public partial class SubUnitSetOverride : IOverride
	{
        public static string Name = "SubUnitSet";
	...
	public static class SubUnitSetOverrideExtensions
    {
		/// <summary>
        /// Apply SubUnitSet edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The SubUnitSet Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<SubUnitSetOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, SubUnitSetIdentity, bool> identityMatch,
            Func<T, SubUnitSetOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The SubUnitSet Overrides to apply — typically `input.Overrides.SubUnitSet`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<SubUnitSetOverride> overrideData,
            Func<T, SubUnitSetIdentity, bool> identityMatch,
            Func<T, SubUnitSetOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.SubUnitSet)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.SubUnitSet)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.SubUnitSet)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<SubUnitSetOverride> edits,
            IList<SubUnitSetOverrideAddition> additions,
            IList<SubUnitSetOverrideRemoval> removals,            Func<SubUnitSetOverrideAddition, T> createElement,
            Func<T, SubUnitSetIdentity, bool> identityMatch,
            Func<T, SubUnitSetOverride, T> modifyElement,
